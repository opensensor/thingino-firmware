...
INGENIC_OPENSDK_SITE = https://github.com/opensensor/openingenic.git
#INGENIC_OPENSDK_SITE = https://github.com/OpenIPC/openingenic
INGENIC_OPENSDK_VERSION = $(shell git ls-remote $(INGENIC_OPENSDK_SITE) linux-4.4 | head -1 | cut -f1)
